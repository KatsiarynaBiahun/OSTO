...
while ($i < $num) { 
    ...
    $ilmoitus_nimi</b></td></tr><tr><td>$ilmoitus_kuvaus</td></tr><tr><td>Ilmoitus jätetty: 
    $ilmoitus_oikeapaivays</td></tr><tr><td>Ilmoittaja: $myyja_tunnus 
    (<a href='mailto: $myyja_sahkoposti'>$myyja_sahkoposti</a>)</td></tr>"; 

    if ((isset($_SESSION['kayttaja_id']) AND $_SESSION['kayttaja_id'] == $myyja_id) OR 
    (isset($_SESSION['kayttaja_taso']) AND $_SESSION['kayttaja_taso'] == "admin")) { 
        echo "<tr><td><form action='poistailmoitus.php' method='post'/><input type='hidden' 
        name='poista' value='1'><input type='hidden' name='poista_id' 
