...
//tämä if isset on lisätty, kokeilu
...
echo "<p>Ilmoitustyyppi: <b>".$ilmoitus_laji."</b><br><br>Muuta: <select name='ilmoitus_uusilaji'><option value='1'>Myydään</option><option value='2'>Ostetaan</option></select></p>";
echo "<p>Kohteen nimi: <input name='ilmoitus_uusinimi' type='text' size='50' value='$ilmoitus_nimi'><p>";
echo "<p>Kohteen kuvaus: <textarea name='ilmoitus_uusikuvaus' rows='5' cols='80'>$ilmoitus_kuvaus</textarea></p>";
