...
if($_SESSION['LOGGEDIN']==1) {
    ...
    echo "<p>Ilmoitustyyppi: <select name='ilmoitus_laji'><option value='1'>Myydään</option><option value='2'>Ostetaan</option></select></p>";
    echo "<p>Kohteen nimi: <input name='ilmoitus_nimi' type='text' size='50'></p>";
    echo "<p>Kohteen kuvaus: <textarea name='ilmoitus_kuvaus' rows='5' cols='80'></textarea></p>";
